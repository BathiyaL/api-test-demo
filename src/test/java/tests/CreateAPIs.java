...
public class CreateAPIs extends BaseTest{
	...
	public void initTest(String baseurlParm, int apiCount) throws URISyntaxException {
        ...
        authenticationObject.setEndpoint(baseURI.resolve("client-registration/v0.17/register").toString());
        authenticationObject.setTokenUrl(baseURI.resolve("oauth2/token").toString());
	...
	public void dataGeneration() {
		...
		for(int i=1 ; i<=apiCount ; i++) {
	        Response createApiResponse  = RestAssured.given()
	                ...
	                .post(baseURI.resolve("api/am/publisher/v3/apis"));
